...
interpolate.o:interpolate.c interpolate.h grid.h
	gcc -Wall interpolate.c -g -c
...
update.o:update.c update.h grid.h particles.h interpolate.h
	gcc -Wall update.c -g -c

embox:embox.o update.o initialise.o embox_funcs.o interpolate.o
	gcc embox.o initialise.o embox_funcs.o update.o interpolate.o  -g -lm -o embox
